...
enum NodeClass : int8_t {
  NodeClass_Resource = 0,
  NodeClass_Method = 1,
  NodeClass_Type = 2,
  NodeClass_MIN = NodeClass_Resource,
  NodeClass_MAX = NodeClass_Type
};

inline const NodeClass (&EnumValuesNodeClass())[3] {
...
inline const char *EnumNameNodeClass(NodeClass e) {
  if (flatbuffers::IsOutRange(e, NodeClass_Resource, NodeClass_Type)) return "";
...
struct MetadataT : public flatbuffers::NativeTable {
  ...
  comm::datalayer::NodeClass nodeClass = comm::datalayer::NodeClass_Resource;
