...
inline bool isSimpleType(VariantType type) { return ((type >= VariantType::BOOL8) && (type <= VariantType::STRING)); }

//! Is type an array data type
//! @param[in]  type     Type to check
//! @return true if type is an array data type
inline bool isArrayType(VariantType type) { return ((type >= VariantType::ARRAY_OF_BOOL8) && (type <= VariantType::ARRAY_OF_STRING)); }
...
public:
  ...
  {
    VariantType type = getVariantTypeID<T*>();
    size_t dataSize = getDataLength<T>(values[0]);
  ...
  DlResult deserialize(uint8_t* buffer, size_t size)
  {
    ...
    if (newType > VariantType::FLATBUFFERS) {
      return DlResult::DL_TYPE_MISMATCH;
    }
  ...
  operator const uint64_t*()    const { if (m_type == VariantType::UINT64)  { return &m_value.ui64; } else { if (m_type == VariantType::ARRAY_OF_UINT64)  { return reinterpret_cast<uint64_t*>(m_value.buffer.buffer); } else { return nullptr; } } }
  ...
  std::string typeAsString() const
  {
    ...
    switch (m_type)
    {
      case VariantType::UNKNOWN:           result = "unknown";     break;
      case VariantType::BOOL8:             result = "bool8";       break;
      case VariantType::INT8:              result = "int8";        break;
      case VariantType::UINT8:             result = "uint8";       break;
      case VariantType::INT16:             result = "int16";       break;
      case VariantType::UINT16:            result = "uint16";      break;
      case VariantType::INT32:             result = "int32";       break;
      case VariantType::UINT32:            result = "uint32";      break;
      case VariantType::INT64:             result = "int64";       break;
      case VariantType::UINT64:            result = "uint64";      break;
      case VariantType::FLOAT32:           result = "float";       break;
      case VariantType::FLOAT64:           result = "double";      break;
      case VariantType::STRING:            result = "string";      break;
      case VariantType::ARRAY_OF_BOOL8:    result = "arbool8";     break;
      case VariantType::ARRAY_OF_INT8:     result = "arint8";      break;
      case VariantType::ARRAY_OF_UINT8:    result = "aruint8";     break;
      case VariantType::ARRAY_OF_INT16:    result = "arint16";     break;
      case VariantType::ARRAY_OF_UINT16:   result = "aruint16";    break;
      case VariantType::ARRAY_OF_INT32:    result = "arint32";     break;
      case VariantType::ARRAY_OF_UINT32:   result = "aruint32";    break;
      case VariantType::ARRAY_OF_INT64:    result = "arint64";     break;
      case VariantType::ARRAY_OF_UINT64:   result = "aruint64";    break;
      case VariantType::ARRAY_OF_FLOAT32:  result = "arfloat";     break;
      case VariantType::ARRAY_OF_FLOAT64:  result = "ardouble";    break;
      case VariantType::ARRAY_OF_STRING:   result = "arstring";    break;
      case VariantType::RAW:               result = "raw";         break;
      case VariantType::FLATBUFFERS:       result = "flatbuffers"; break;
      default:
        result = "";
        break;
    }
  ...
  VariantType getTypeByName(std::string type) const
  {
    if (type == "bool8")       { return VariantType::BOOL8; }
    if (type == "int8")        { return VariantType::INT8; }
    if (type == "uint8")       { return VariantType::UINT8; }
    if (type == "int16")       { return VariantType::INT16; }
    if (type == "uint16")      { return VariantType::UINT16; }
    if (type == "int32")       { return VariantType::INT32; }
    if (type == "uint32")      { return VariantType::UINT32; }
    if (type == "int64")       { return VariantType::INT64; }
    if (type == "uint64")      { return VariantType::UINT64; }
    if (type == "float")       { return VariantType::FLOAT32; }
    if (type == "double")      { return VariantType::FLOAT64; }
    if (type == "string")      { return VariantType::STRING; }
    if (type == "arbool8")     { return VariantType::ARRAY_OF_BOOL8; }
    if (type == "arint8")      { return VariantType::ARRAY_OF_INT8; }
    if (type == "aruint8")     { return VariantType::ARRAY_OF_UINT8; }
    if (type == "arint16")     { return VariantType::ARRAY_OF_INT16; }
    if (type == "aruint16")    { return VariantType::ARRAY_OF_UINT16; }
    if (type == "arint32")     { return VariantType::ARRAY_OF_INT32; }
    if (type == "aruint32")    { return VariantType::ARRAY_OF_UINT32; }
    if (type == "arint64")     { return VariantType::ARRAY_OF_INT64; }
    if (type == "aruint64")    { return VariantType::ARRAY_OF_UINT64; }
    if (type == "arfloat")     { return VariantType::ARRAY_OF_FLOAT32; }
    if (type == "ardouble")    { return VariantType::ARRAY_OF_FLOAT64; }
    if (type == "arstring")    { return VariantType::ARRAY_OF_STRING; }
    if (type == "raw")         { return VariantType::RAW; }
    if (type == "flatbuffers") { return VariantType::FLATBUFFERS; }
